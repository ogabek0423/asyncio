...
async def task3():
    await asyncio.sleep(21-3)
    print("task 3 complete ->", datetime.datetime.now())


async def task4():
    await asyncio.sleep(21-4)
...
async def task13():
    await asyncio.sleep(21-13)
    print("task 13 complete ->", datetime.datetime.now())


async def task14():
    await asyncio.sleep(21-14)
